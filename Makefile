...
DISTDIR = /home/cse57493/multicore_book_code/gameOfLife/.tmp/GameOfLife1.0.0
LINK          = g++
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/GameOfLife/bin || mkdir -p $(INSTALL_ROOT)/opt/GameOfLife/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/GameOfLife/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/GameOfLife/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/GameOfLife/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/GameOfLife/bin/ 
